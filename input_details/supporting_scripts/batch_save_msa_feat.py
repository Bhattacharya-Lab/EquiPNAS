#slightly modified https://github.com/sokrypton/ColabFold/blob/main/colabfold/batch.py to save msa_first_row representation in .npy format as msa feature. 
...
def batch_input(
    ...
    from alphafold.msa import make_fixed_size
...
def predict_structure(
    ...
    for (model_name, model_runner, params) in model_runner_and_params:
        ...
        np.save(str(result_dir) + 'msa_first_row', prediction_result['representations']['msa_first_row'])
        exit()
...
def generate_input_feature(
    ...
    from colabfold import chain_break
